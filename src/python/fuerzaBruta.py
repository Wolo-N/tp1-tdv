...
def main():
    ...
    # Usamos un loop para correr todas las instancias.
    for filename in files:
        ...
        # Usamos un loop para correr varios tests.
        for w in range(6,10):
        # Define los parámetros de la grilla y los breakpoints.
            ...
            # Calculamos el tiempo promedio de ejecucion.
            ...
            # Exportamos la solución a un archivo JSON
