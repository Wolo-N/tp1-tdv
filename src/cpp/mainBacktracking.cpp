...
#include "backtracking.cpp" // Reemplaza "backtracking.h" con el nombre real de tu archivo de encabezado para backtracking
...
void main()
{
    ...
    for (const std::string &filename : files)
    {
        ...
        // Calcular la solución usando backtracking
        Solution solution = backtracking(m, n, N, instance);
